...
Com_Zimbra_SignatureZimlet.prototype.singleClicked = function() {
  ...
  var signatureContents = {name: 'İmza Şablonu', value: signatureHtml, contentType: 'html'};
...
Com_Zimbra_SignatureZimlet.prototype._success = function() {
  ...
  appCtxt.getAppController().setStatusMsg("Değişikliklerin uygulanması CTRL+F5 ile tarayıcınızı yenileyin...", ZmStatusView.LEVEL_INFO, null , transitions);
...
Com_Zimbra_SignatureZimlet.prototype._okBtnListener = function() {
  ...
  var signatureHtml = AjxTemplate.expand("com_zimbra_signature_zimlet.templates.signatureBase#Main", dataObject);
  var signatureContents = {name: 'İmza Şablonu', content: signatureHtml, contentType: 'text/html'};
  ...
  if(signatures._nameMap['İmza Şablonu'])
  {
